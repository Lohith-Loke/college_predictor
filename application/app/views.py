...
def index():
    ...
    if(request.method == "POST"):
        ...
        return render_template("public/result.html",ranks=ranks,category=category,tables=[result.to_html(classes='data')], titles=result.columns.values,time=time)

    return render_template("public/index.html",time=time)
